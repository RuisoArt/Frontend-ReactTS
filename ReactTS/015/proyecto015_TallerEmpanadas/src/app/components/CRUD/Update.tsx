    ...
    for (let i = 0; i < limit; i++) {
      ...
      if (comparar === specificElement?.codEmpanada) {
        arrayEmpanada[i] = new Empanada(
          ...
          imagenEmpanada === imgBase64? specificElement.imagenEmpanada : imagenMiniatura,
          //imgBase64,
        );
      }
    }
          ...
          <Form validated={inProcess} onSubmit={enviarFormulario} noValidate>
            ...
            <div className="d-flex justify-content-center">
              ...
              <div className="card-header text-center">
                <span className="titulo">Actualiza los datos <br/> de tu Empanada</span>
              </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="mb-3">
                      <Form.Group controlId="tipoEmpanada">
                        <Form.Label>
                          <span className="delete">*</span> Tipo de Empanada
                        </Form.Label>
                      ...
                      <Form.Group controlId="nombreImagen">
                        <Form.Label>
                          ...
                          <span className="delete">
                            {" "}{specificElement ? specificElement.nombreImagen: ""}
                          </span>
                        </Form.Label>
                        <Form.Control
                          size="sm"
